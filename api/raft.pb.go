...
func (p *authenticatedWrapperRaftServer) RaftMessageStream(stream Raft_RaftMessageStreamServer) error {

	if err := p.authorize(stream.Context(), []string{"swarm-manager"}); err != nil {
		return err
	}
	return p.local.RaftMessageStream(stream)
}
...
type RaftClient interface {
	...
	RaftMessageStream(ctx context.Context, opts ...grpc.CallOption) (Raft_RaftMessageStreamClient, error)
...
func (c *raftClient) RaftMessageStream(ctx context.Context, opts ...grpc.CallOption) (Raft_RaftMessageStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Raft_serviceDesc.Streams[0], c.cc, "/docker.swarmkit.v1.Raft/RaftMessageStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftRaftMessageStreamClient{stream}
	return x, nil
}

type Raft_RaftMessageStreamClient interface {
	Send(*ProcessRaftMessageRequest) error
	CloseAndRecv() (*ProcessRaftMessageResponse, error)
	grpc.ClientStream
}

type raftRaftMessageStreamClient struct {
	grpc.ClientStream
}

func (x *raftRaftMessageStreamClient) Send(m *ProcessRaftMessageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftRaftMessageStreamClient) CloseAndRecv() (*ProcessRaftMessageResponse, error) {
...
type RaftServer interface {
	...
	// to be processed on a raft member.
	// It is called from the RaftMember willing to send a message to its destination ('To' field)
	RaftMessageStream(Raft_RaftMessageStreamServer) error
	// ResolveAddress returns the address where the node with the given ID can be reached.
...
func _Raft_RaftMessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServer).RaftMessageStream(&raftRaftMessageStreamServer{stream})
}

type Raft_RaftMessageStreamServer interface {
	SendAndClose(*ProcessRaftMessageResponse) error
	Recv() (*ProcessRaftMessageRequest, error)
	grpc.ServerStream
}

type raftRaftMessageStreamServer struct {
	grpc.ServerStream
}

func (x *raftRaftMessageStreamServer) SendAndClose(m *ProcessRaftMessageResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftRaftMessageStreamServer) Recv() (*ProcessRaftMessageRequest, error) {
	m := new(ProcessRaftMessageRequest)
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Raft_RaftMessageStream_Handler,
			ClientStreams: true,
		},
	},
...
type Raft_RaftMessageStreamServerWrapper struct {
	Raft_RaftMessageStreamServer
	ctx context.Context
}

func (s Raft_RaftMessageStreamServerWrapper) Context() context.Context {
	return s.ctx
}

func (p *raftProxyRaftServer) RaftMessageStream(stream Raft_RaftMessageStreamServer) error {
	ctx := stream.Context()
	conn, err := p.connSelector.LeaderConn(ctx)
	if err != nil {
		if err == raftselector.ErrIsLeader {
			...
			streamWrapper := Raft_RaftMessageStreamServerWrapper{
				Raft_RaftMessageStreamServer: stream,
				ctx: ctx,
			}
			return p.local.RaftMessageStream(streamWrapper)
		}
		return err
	}
	...
	clientStream, err := NewRaftClient(conn).RaftMessageStream(ctx)
...
var fileDescriptorRaft = []byte{
	...
	,
}
